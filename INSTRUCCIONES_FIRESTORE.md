...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    match /groups/{groupId} {
      // Se puede leer si el usuario está autenticado (para ver información de invitación y unirse)
      ...
      //    Verificamos que solo se agregue a sí mismo y que no esté ya en el grupo
